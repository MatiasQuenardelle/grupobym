...
const STATS = [
  { value: "50-70%", label: "Pérdida de exceso de peso" },
  { value: "~1 hora", label: "Duración de la cirugía" },
  { value: "48 hs", label: "Internación" },
  { value: "#1", label: "Procedimiento más realizado" },
];
