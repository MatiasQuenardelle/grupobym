      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-lg text-secondary-500">
            Atendemos en Resistencia y Sáenz Peña, Chaco.
          </p>
        </div>
        ...
        <div className="mt-12 grid gap-8 lg:grid-cols-3">
          ...
          <div className="lg:col-span-2 overflow-hidden rounded-2xl shadow-lg">
            <iframe
              ...
              title="Ubicación de GrupoByM en Resistencia, Chaco"
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="rounded-2xl bg-white p-6 shadow-md">
              <div className="flex items-center gap-3">
                ...
                <h3 className="text-lg font-bold text-secondary-700">Sáenz Peña</h3>
              </div>
              <p className="mt-3 text-sm text-secondary-600">Presidencia Roque Sáenz Peña, Chaco</p>
