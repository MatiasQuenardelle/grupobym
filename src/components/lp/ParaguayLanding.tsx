          ...
          <div className="text-center lg:text-left lg:grid lg:grid-cols-2 lg:gap-16 lg:items-center">
            <div className="py-8 lg:py-16">
              ...
              <h1 className="text-balance text-4xl font-extrabold tracking-tight text-white sm:text-5xl lg:text-6xl">
                Cirugía Bariátrica desde Paraguay{" "}
              ...
              <div className="mt-8 flex flex-col items-center justify-center gap-4 sm:flex-row lg:justify-start">
                <a
                  ...
                  onClick={() => trackWhatsAppClick("lp_paraguay_hero")}
      ...
      <section className="py-16 md:py-20 bg-white">
        <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
          <h2 className="text-center text-3xl font-extrabold text-secondary-700 sm:text-4xl">
            La misma cirugía, la mitad del costo
          </h2>
          <p className="mx-auto mt-4 max-w-2xl text-center text-lg text-secondary-500">
            Y no solo es más económico — incluye más servicios que la mayoría de las clínicas en Paraguay.
          </p>
          ...
          <div className="mt-12 grid gap-6 md:grid-cols-2">
            ...
            <div className="rounded-2xl border-2 border-gray-200 bg-gray-50 p-6">
              <div className="mb-4 flex items-center gap-3">
                ...
                <h3 className="text-xl font-bold text-secondary-700">En Paraguay</h3>
              </div>
              <div className="mb-6">
                <p className="text-3xl font-extrabold text-secondary-400 line-through decoration-red-400 decoration-2">
                  Precio completo
                </p>
              </div>
              <ul className="space-y-3 text-secondary-500">
                ...
                <li className="flex items-center gap-2">
                  ...
                  Traslado por tu cuenta
                </li>
              </ul>
            </div>

            {/* GrupoByM */}
            <div className="rounded-2xl border-2 border-primary-400 bg-white p-6 shadow-xl shadow-primary-400/10 relative">
              <div className="absolute -top-3.5 left-1/2 -translate-x-1/2 rounded-full bg-primary-400 px-4 py-1 text-xs font-bold text-white uppercase tracking-wider">
                Mejor opción
              </div>
              <div className="mb-4 flex items-center gap-3">
                <span className="text-2xl">🇦🇷</span>
                <h3 className="text-xl font-bold text-secondary-700">En GrupoByM</h3>
              </div>
              <div className="mb-6">
          ...
          <div className="mt-8 text-center">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              onClick={() => trackWhatsAppClick("lp_paraguay_comparison")}
              className="inline-flex items-center gap-2 rounded-full bg-[#25D366] px-8 py-3.5 text-base font-semibold text-white shadow-lg shadow-[#25D366]/25 transition-all hover:bg-[#20BD5A] active:scale-[0.98]"
            >
              <WhatsAppIcon className="h-5 w-5" />
        ...
        <div className="mx-auto max-w-3xl px-4 text-center sm:px-6 lg:px-8">
          ...
          <div className="mt-8">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              onClick={() => trackWhatsAppClick("lp_paraguay_bottom")}
              className="inline-flex items-center gap-2 rounded-full bg-[#25D366] px-8 py-3.5 text-base font-semibold text-white shadow-lg shadow-[#25D366]/25 transition-all hover:bg-[#20BD5A] active:scale-[0.98]"
            >
              <WhatsAppIcon className="h-5 w-5" />
