...
export default function LandingDoctor() {
  return (
        ...
        <div className="grid items-center gap-12 lg:grid-cols-2">
          ...
          <div>
            ...
            <p className="mt-2 text-lg font-medium text-accent-400">
              Cirujano General | Laparoscopista | Bariátrico |
            ...
            <div className="mt-6 space-y-4 text-secondary-600 leading-relaxed">
              ...
              <p>
                ...
                participación activa en congresos nacionales e internacionales de
                cirugía bariátrica. Representante de SACO en el Congreso
