  ...
  const steps = [
    {
      ...
      title: "Escribinos",
      description:
        "Contactanos por WhatsApp o teléfono. Te respondemos en menos de 2 horas y evaluamos tu caso sin compromiso.",
      icon: (
    ...
    },
    {
      ...
      description:
        "Nuestro equipo interdisciplinario evalúa tu caso y te orienta sobre el mejor camino para vos.",
      icon: (
        <svg className="h-6 w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
    ...
    },
    {
      ...
      description:
        "Cirugía mínimamente invasiva con seguimiento completo de por vida. Te acompañamos en cada etapa.",
      icon: (
        <svg className="h-6 w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          ...
          <h2 className="mt-2 text-3xl font-extrabold text-secondary-700 sm:text-4xl">
            De la consulta a tu nueva vida
          </h2>
