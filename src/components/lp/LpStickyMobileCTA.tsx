...
import { trackStickyCtaClick, trackWhatsAppClick } from "@/lib/tracking";
...
export default function LpStickyMobileCTA() {
  ...
  return (
    ...
    >
      <div className="flex items-center gap-3 bg-secondary-900/95 backdrop-blur-sm px-4 py-3 shadow-[0_-4px_20px_rgba(0,0,0,0.3)]">
        <a
          href="#reservar"
