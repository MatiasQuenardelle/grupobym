  ...
  return (
    <footer className="bg-secondary-800 text-white">
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
          ...
          <div>
            ...
            <div className="flex gap-3 mb-4">
              <a
                ...
                className="flex h-9 w-9 items-center justify-center rounded-full bg-secondary-700 transition-colors hover:bg-primary-400"
              >
        ...
        <div className="mt-10 border-t border-secondary-700 pt-6 text-center text-xs text-gray-400">
          <p>&copy; {new Date().getFullYear()} {PRACTICE_NAME}. Todos los derechos reservados.</p>
        </div>
      </div>
    </footer>
  );
